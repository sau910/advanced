...
<body>
  ...
  <table border="1">
    ...
    <td>
    <%=employee.getEmployeeName() %></td>
    <td>
    <%=employee.getDesignation() %></td>
   <td>
    <%=employee.getSalary() %></td>
    <td>
    <%=employee.getGender() %></td>
     <td>
    <%=employee.getCity() %></td>
    <td><a href="deleteEmployee?requestAction=delete&employeeId=<%=employee.getEmployeeId() %>">Delete</td>
